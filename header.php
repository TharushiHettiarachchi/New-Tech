...
<body>
    <div class="col-12">
        <div class="row p-2 p-lg-0">
            ...
            <div class="col-lg-3 col-4 title1 mt-2 fs-3">NEW TECH</div>
            <div class="col-4 col-lg-2 text-lg-start text-end mt-3">
                <p>Hello Tharushi !</p>
            </div>
            <div id="b3" class="col-4  col-lg-1 mt-2 offset-lg-2">
                <button class="btn btn-outline-primary" id="b1" onclick="changeButton();" style="border-radius: 20px;">Sign Out</button>
                <button class="btn btn-outline-primary d-none" onclick="window.location = 'index.php'" id="b2" style="border-radius: 20px;">Sign In | Register</button>
            </div>
            <div class="col-1 offset-5 offset-lg-0"><i class="bi bi-person-fill fs-2"></i></div>
