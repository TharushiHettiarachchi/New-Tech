    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-12 fs-1 text-dark text-center">Watchlist</div>
                <div class="col-7">
                    <div class="row">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-2 col-12 p-3">
                            <div class="row p-3 border border-primary border-2 rounded pt-6 pb-6">
                                <div class="col-12 btn btn-primary mt-3" onclick="window.location = 'watchlist.php';">Watchlist</div>
                                <div class="col-12 btn btn-primary mt-3" onclick="window.location = 'cart.php';">Cart</div>
                                <div class="col-12 btn btn-primary mt-3" onclick="window.location = 'recent.php';">Recent</div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img src="resource/product_img/apple.jfif" class="img-fluid rounded-start h-100">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-12 d-grid">
                                                        <div class="row pe-3 ps-3">
                                                            ...
                                                            <button class="btn btn-primary mt-2 mt-lg-3 ms-lg-1 col-12 col-lg-6">Remove</button>
